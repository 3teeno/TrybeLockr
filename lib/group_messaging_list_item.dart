...
class GroupMessagingListItem extends StatelessWidget{
  final DataSnapshot messageSnapshot;
  final Animation animation;
  GroupMessagingListItem({this.messageSnapshot, this.animation});

  var usernameController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    usernameController.text = messageSnapshot.value["username"];
                    ...
                    children: <Widget>[
                      ConstrainedBox(
                          ...
                          child: IntrinsicWidth(
                              child:TextField(controller: usernameController,maxLength: 10,maxLines:1,style: TextStyle(fontSize: 14,color: Colors.lightBlueAccent),decoration: InputDecoration(
                                isDense: true,
                                counterText: "",
          ...
          Visibility(
            ...
            child:  Container(
              ...
              child:  Bubble(
                ...
                constraints: BoxConstraints(minWidth: 60),
                child: IntrinsicWidth(
                  child:TextField(controller: usernameController,maxLength: 10,maxLines:1,style: TextStyle(fontSize: 14,color: Colors.lightBlueAccent),
