...
class ResetPassAccList extends StatefulWidget {


  @override
  ResetPassAccListState createState() => ResetPassAccListState();
}

class ResetPassAccListState extends State<ResetPassAccList> {
          ...
          children: <Widget>[
            Center(
                child: Column(
                  ...
                  children: [
                    settingsHeader('Reset Password Accounts',MemoryManagement.getuserprofilepic()),
                                  ...
                                  InkWell(
                                      onTap: () {
                                        Navigator.of(context, rootNavigator: false)
                                            .push(MaterialPageRoute(builder: (context) => GroundedPasswordreset(groundAcctslist[i]))).then((value){
                                          if(value!=null){
                                            if(value==true){
                                              getaccounts();
                                            }
